...
//    CGPathAddRect(path, NULL, CGRectMake(10, 10, 300.0, 200.0)); // 6-2
//    CTFramesetterRef framesetter = CTFramesetterCreateWithAttributedString((CFAttributedStringRef)_attributedString); // 7-2
//    CTFrameRef theFrame = CTFramesetterCreateFrame(framesetter, CFRangeMake(0, [_attributedString length]), path, NULL); // 8-2
...
//    CGPathAddRect(path, NULL, CGRectMake(10, 10, 300.0, 200.0)); // 6-2
//    CTFramesetterRef framesetter = CTFramesetterCreateWithAttributedString((CFAttributedStringRef)_attributedString); // 7-2
//    CTFrameRef textFrame = CTFramesetterCreateFrame(framesetter, CFRangeMake(0, [_attributedString length]), path, NULL); // 8-2
