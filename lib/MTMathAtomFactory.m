...
//Test russian sуmbol. Сyrillic symbol observing
//+ (BOOL)hasRussianCharacters:(NSString *) chStr{
...
//    return [chStr rangeOfCharacterFromSet:set].location != NSNotFound;
//}
